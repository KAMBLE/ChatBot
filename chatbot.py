#buildding chat bot with deep NLP
import numpy as np
...
#creating two dictionaries that will map questions words and answers words to unique inetger 
...
#Adding EOS token to end of clean_Answers 
for i in range(len(clean_answers)) :
    clean_answers[i] += ' <EOS>'

#Translating all the questions ans the answers into integers
...
#creaing placeholders for input and trgets
def model_inputs():
